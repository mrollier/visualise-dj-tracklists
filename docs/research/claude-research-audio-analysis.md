...
- `energy` today = regex over Rekordbox Comments for MIK "Energy N" tags (`energyFromComments`, model.ts:95). Only ~20 of 2080 tracks carry the tag — those 20 double as a free calibration set for analysed energy.
